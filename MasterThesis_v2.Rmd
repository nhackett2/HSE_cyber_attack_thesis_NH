...
The Health Service Executive ("HSE") is the single body that is responsible for the delivery of public health and social care services in the Republic of Ireland ("Ireland"). Established in 2005, it replaced the Health Boards that were previously in charge of these services. The abolishment of these Health Boards were part of significant reforms in the organisation of the Irish health system since 1970. With a budget exceeding 13 billion euros in 2009, it was Ireland's largest employer comprising of more than 65,000 staff directly employed (Mcdaid et al. 2009). In February 2024, The Minister for Health - Stephen Donnelly, has just approved the 2024 National Service Plan (NSP) for the HSE with an allocated budget of 23.5 billion euros. With an 4.6% increase from the prior year budget (Health Service Executive 2024), it looks to be that this substantial budget is steadily set to increase each year.

Unfortunately, this does not automatically translate to the HSE being the most efficient business. Outpatient waiting lists for hospital appointments have been a long-standing issue for the public hospitals. The National Treatment Purchase Fund ("NTPF"), an independent statutory body established by the Minister for Health, posts monthly statistics on the outpatient waiting lists for all of the public hospitals in Ireland. Throughout the years, monthly public hospital waiting list figures have exhibited high numbers (in the tens of thousands) in the range of 18+ months waiting for outpatient hospital appointments. As at the time of this study, the latest figures published are pertaining to June 2024 with 52,338 people in the 18+ month range for all public hospitals combined. For reference, in June 2018 the figure was 80,679 (The National Treatment Purchase Fund 2024). There are several reasons for this staggering number. For instance, A Do Not Attend ("DNA") is when a patient unexpectedly fails to show up for their appointment. It may be the case of the patient going to a private clinic or recovering before the appointment date. In this instance, the outpatient waiting lists are only updated following the date of the non-attended appointment. This indeed leads to inefficient use of staff time, worse care for patients, and increase waiting times for patients (Department of Health 2024). While some public hospitals have long adopted the DiaryBook portal, which "was created in 2006 to provide appointment management software and to automatically send appointment reminders by SMS text" (Health Service Executive n.d.), others have been slower on the up-take. This is important as in a previous review, 28/29 studies concluded that an SMS reminder for appointments reduced DNAs by 34%, on average (Hasvold and Wootton, 2011). 

However, a major cyber attack on the HSE in 2021 caused a significant, if not the most significant, disruption on the public hospital outpatient waiting lists. On the 14th of May 2021, all IT systems such as PCs and servers were hacked after an employee opened a malware-ridden email. Behind the attack were the Russian-based Conti ransomware group, who asked the HSE for $20m to restore services. The HSE were presumably targeted due to it being a large organisaiton (Sheils McNamee 2021). In an attempt to assess the impact on this attack, the IT systems were shut off and thus the healthcare employees no longer had access. In order to maintain providing patient care and services, these employees were forced to revert to using telephones and pen and paper as even emails were not accessible. This disruption lasted over four months (PricewaterhouseCoopers 2021). Consequently, outpatient appointments had no choice but to be cancelled and the waiting lists could not be updated for some time. One patient nearing the final stages of her radiation treatment at the time recalls being informed that her radiation was paused as staff were not able to access the correct coordinates used with the machine for her treatment. Thankfully, another hospital had the machinery separate from the wider system and the treatment carried out without long-term delay. However, this period of not knowing caused great distress for the patient (Sheils McNamee 2021). 

The predominant motivation for this paper is that unforeseen events can disrupt hospital services at any time. Cyber hackers are becoming more sophisticated and advanced with their skills. Therefore, it is essential that hospitals are equipped with advanced practices and robust systems to mitigate disruptions and ensure the continuity of patient care. Not every public hospital operates the same. As aforementioned, some hospitals have been using the DiaryBook portal for a number of years while some have not, which highlights the need for tailored strategies. In this study, several public hospital outpatient waiting lists will be analysed, with a focus on forecasting which hospitals are likely to recover more effectively from such disruptions over the long term. Utilising Time Series Analysis and Machine Learning techniques, the research will identify patterns and predictors of resilience among hospitals. The findings will provide valuable insights in which other hospitals can learn from the more efficient ones and work on implementing their practices in order to better prepare for future unforeseen disruptions and contribute to better recovery outcomes.



## Data 

The data to be used in this study are the monthly outpatient waiting list figures retrieved from the NTPF. As previously stated, the NTPF are a corporate body with functions and responsibilities as set out under Statutory Instrument 179 - National Treatment Purchase Fund (Establishment) Order, 2004 and the Nursing Homes Support Scheme Act (2009). The body also performs any other function assigned by the Minister for Health, since July 2012 this includes responsibility for the publication of outpatient waiting lists (The National Treatment Purchase Fund n.d.). 
